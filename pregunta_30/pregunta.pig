...
data1 = FOREACH data GENERATE col3,  ToString(ToDate(col3,'yyyy-MM-dd',
    'America/Bogota'),'dd'), ToString(ToDate(col3,'yyyy-MM-dd',
    'America/Bogota'),'d'), ToString(ToDate(col3,'yyyy-MM-dd',
    'America/Bogota'),'EEEE');
